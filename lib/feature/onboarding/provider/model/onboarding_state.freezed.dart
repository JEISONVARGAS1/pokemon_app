...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OnboardingState&&(identical(other.currentPageIndex, currentPageIndex) || other.currentPageIndex == currentPageIndex));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( OnboardingStateData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case OnboardingStateData() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( OnboardingStateData value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( OnboardingStateData value)?  $default,){
final _that = this;
switch (_that) {
case OnboardingStateData() when $default != null:
return $default(_that);case _:
...
class OnboardingStateData implements OnboardingState {
  const OnboardingStateData({this.currentPageIndex = 0});
...
@pragma('vm:prefer-inline')
$OnboardingStateDataCopyWith<OnboardingStateData> get copyWith => _$OnboardingStateDataCopyWithImpl<OnboardingStateData>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OnboardingStateData&&(identical(other.currentPageIndex, currentPageIndex) || other.currentPageIndex == currentPageIndex));
}
...
/// @nodoc
abstract mixin class $OnboardingStateDataCopyWith<$Res> implements $OnboardingStateCopyWith<$Res> {
